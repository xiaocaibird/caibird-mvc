    ...
    const rules: webpack.Module['rules'] = [
        {
            ...
            use: [{
                ...
                options: {
                    babelrc: false,
                    ...getBabelrc({ projectName, runPlatforms: ['web'], unionProjectNames, useRequestApiReplace: true, projectVersion: CaibirdEnv.PROJECT_VERSION }),
                },
            }, {
                loader: 'ts-loader',
                options: {
        ...
        ...(isLocalTest && !process.env._CAIBIRD_BABEL_TRANSFORM_ALL ? [] : [{
            ...
            use: [{
                loader: 'babel-loader',
                options: {
                    ...getBabelrc({ projectName, runPlatforms: ['web'], projectVersion: CaibirdEnv.PROJECT_VERSION }),
