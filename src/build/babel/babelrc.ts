    ...
    if (isDist) {
        ...
        plugins.push(['module-resolver', {
            ...
            alias: {
                ...
                'caibird-scenes-general-manage-extsys-server': '../@scenes/general-manage-extsys/server',
                'caibird-scenes-general-manage-extsys-web': '../@scenes/general-manage-extsys/front/web',
